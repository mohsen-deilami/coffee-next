  ...
  return (
    ...
    <div className="row mx-0 pt-5 px-sm-3 px-lg-5 mt-4">
        <div className="col-lg-3 col-md-6 mb-5">
            ...
            <p><i className="fa fa-map-marker-alt mr-2"></i>14 Straße, Koeln , Deutschland</p>
            <p><i className="fa fa-phone-alt mr-2"></i>+49 1573820 3610</p>
            <p className="m-0"><i className="fa fa-envelope mr-2"></i>mohsen.deilami6570@gmail.com</p>
        </div>
        <div className="col-lg-3 col-md-6 mb-5">
        ...
        <div className="col-lg-3 col-md-6 mb-5">
            ...
            <div className="w-100">
                <div className="input-group">
                    <input type="text" className="form-control border-light" style={{padding: "25px" , borderRadius:0}} placeholder="Your Email"/>
                    <div className="input-group-append">
                        <button className="btn btn-primary font-weight-bold px-3" style={{borderRadius:0}}>Sign Up</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div className="container-fluid text-center text-white border-top mt-4 py-4 px-sm-3 px-md-5" style={{borderColor: "rgba(256, 256, 256, .1) !important"}}>
        ...
        <p className="m-0 text-white">Designed by <a className="font-weight-bold" href="/"> Mohsen Deilami</a></p>
    </div>
    </div>
  )
}
